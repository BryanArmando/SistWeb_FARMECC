        ...
        <div class="inline-block align-bottom backedit rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">    
            <form>
                <div class="backedit px-4 pb-4 sm:p-6 sm:pb-4">
                    <h5 class="p-3 text-white font-bold text-center" style="font-size:25px"> <span class="glyphicon glyphicon-plus-sign"><i class="fa-solid fa-file-circle-plus" style="font-size:30px; padding-right:15px"></i>Nuevo pedido</span></h5>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label for="product" class="block text-white text-sm font-bold mb-2">Cantidad:</label>
