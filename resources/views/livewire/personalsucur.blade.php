<div class="max-w-7xl mx-auto sm:px6 lg:px-8">
    <div class="bg-transparent overflow-hidden  sm:rounded-lg px-4 py-4">
        <p class="justify-content-center" style="color: rgb(71, 30, 255); font-size:24px"><span style="font-weight: bold">Lista del personal de:</span><span style="color: rgb(30, 101, 255);"> {{$sucurbuscArray3['nombre']}}</span></p>
        <table class="table-fixed w-full bg-light">
            ...
            <tbody>
                @foreach($sucurbuscpersonalArray as $item)
                    <tr>
