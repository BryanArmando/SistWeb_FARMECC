...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="font-family: 'Nunito', sans-serif;">
        ...
        <!-- PANEL DE NAVEGACIÓN -->
        <div>
            <nav class=" navbar fixed-top navbar-expand " role="navigation">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse pt-3" id="navbarSupportedContent">
                        ...
                        <ul  class="navbar-nav me-auto">
                            <div>
                                <a class=" navtit navlink text-light text-sm" href="{{ route('inicio') }}">
                                    INICIO
                                </a>
                            </div>
                        </ul>
                        <ul class="navbar-nav me-auto">
                                ...
                                <a wire:model='sicatalogoabrir'  class="navtit navlink text-light text-sm" href="{{route('catalogo.listcatalogo')}}">
                                    CATÁLOGO
                                </a>
                        ...
                        <ul class="navbar-nav me-auto">
                            <div>
                                <a  class="navtit navlink text-sm text-light" href="{{route('contactos')}}">
                                    DOCTORES
                                </a>
                            </div>
                        </ul>
